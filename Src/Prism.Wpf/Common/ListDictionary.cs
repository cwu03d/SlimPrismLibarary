...
{
    Dictionary<TKey, IList<TValue>> _innerValues = new Dictionary<TKey, IList<TValue>>();
    ...
    {
        get { return ((ICollection<KeyValuePair<TKey, IList<TValue>>>)_innerValues).IsReadOnly; }
    }
